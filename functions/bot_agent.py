...
#CLASS: BOT FOR OPENING AND CHECKING TRADES

class BotAgent:

        """
        PRIMARY FUNCTION OF OPENING AND CHECKING ORDER STATUS 
        """
        ...
        def __init__(
            ...
            hedge_ratio,
                ...
                #PAIR STATUS OPETIONS ARE FAILED, LIVE, CLOSE, ERROR
                self.order_dict = {
                        "market_1": market_1,
                        "market_2": market_2,
        ...
        def check_order_status_by_id(self, order_id):
                ...
                #GUARD: IF ORDER NOT FILLED WAIT UNTIL EXPIRATION
        ...
        def open_trade(self):
                ...
                #ENSURING ORDER IS LIVE BEFORE PROCESSING
